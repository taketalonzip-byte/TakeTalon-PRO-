...
export const ESPN_FLAG_CODES: Record<string, string> = {
  ...
  england: "eng", eng: "eng", uk: "eng", unitedkingdom: "eng", greatbritain: "eng",
  spain: "spa", spa: "spa", espana: "spa",
  germany: "ger", ger: "ger", deutschland: "ger",
  france: "fra", fra: "fra",
  italy: "ita", ita: "ita", italia: "ita",
  portugal: "por", por: "por",
  netherlands: "ned", ned: "ned", nederland: "ned", holland: "ned",
  brazil: "bra", bra: "bra", brasil: "bra",
  saudiarabia: "ksa", ksa: "ksa", saudi: "ksa",
  canada: "can", can: "can",
  sweden: "swe", swe: "swe",
  russia: "rus", rus: "rus",
  poland: "pol", pol: "pol",
  argentina: "arg", arg: "arg",
  switzerland: "sui", sui: "sui", swiss: "sui",
  japan: "jpn", jpn: "jpn",
  china: "chn", chn: "chn",
  greece: "gre", gre: "gre",
  serbia: "srb", srb: "srb",
  australia: "aus", aus: "aus", australiaoceania: "aus",
  mexico: "mex", mex: "mex",
  india: "ind", ind: "ind",
  southkorea: "kor", korea: "kor", kor: "kor", southkoreakbl: "kor",
  turkey: "tur", tur: "tur", turkiye: "tur",
  lithuania: "ltu", ltu: "ltu",
  denmark: "den", den: "den",
  finland: "fin", fin: "fin",
  norway: "nor", nor: "nor",
  czechrepublic: "cze", czech: "cze", cze: "cze", czechia: "cze",
  slovakia: "svk", svk: "svk",
  hungary: "hun", hun: "hun",
  croatia: "cro", cro: "cro",
  belgium: "bel", bel: "bel",
  austria: "aut", aut: "aut",
  southafrica: "rsa", rsa: "rsa", za: "rsa",
  pakistan: "pak", pak: "pak",
  newzealand: "nzl", nzl: "nzl",
  westindies: "win", win: "win", caribbean: "win",
  srilanka: "sri", sri: "sri",
  bangladesh: "ban", ban: "ban",
  dominicanrepublic: "dom", dom: "dom",
  puertorico: "pur", pur: "pur",
