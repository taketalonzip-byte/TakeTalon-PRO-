...
const percentKeys = new Set(["pricing_scale_factor", "premium_membership_scale_factor", "games_betting_minimum_scale_factor", "commission_month", "tva_rate"]);
  ...
  const selectedRule = selectedCategory === "ACCESS"
    ...
    : selectedCategory === "SUBSCRIPTION"
      ...
      : selectedCategory === "GAME"
        ? rules.find((rule) => rule.key === "games_betting_minimum_scale_factor")
