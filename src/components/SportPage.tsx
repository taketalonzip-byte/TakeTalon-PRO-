  ...
  return [
    {
      ...
      name: "International",
      flag: <SimpleFlagBox colors={["#1a3650", "#38bdf8", "#1a3650"]} label="International" />,
      leagues: [
    ...
    for (const [countryKey, leagueMap] of liveData.grouped) {
      ...
      if (!exists) {
        extra.push({
          ...
          name: countryKey,
          flag: <SimpleFlagBox colors={["#1a3650", "#38bdf8", "#1a3650"]} label={countryKey} />,
